...
function DoubleRowAutoScrollPartners({ partners }) {
  ...
  const [bottomItems, setBottomItems] = React.useState(() => getFilledItems(bottomRow));
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="overflow-hidden w-full">
          <div ref={topRef} className="flex gap-x-32 will-change-transform py-1 min-w-full">
            {topItems.map((item, idx) => (
              <img
                key={idx}
                src={item.logo}
                alt={item.name}
                className="max-h-16 object-contain mx-auto partner-logo-img"
        ...
        <div className="overflow-hidden w-full">
          <div ref={bottomRef} className="flex gap-x-32 will-change-transform py-1 min-w-full">
