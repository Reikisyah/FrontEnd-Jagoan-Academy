    ...
    <section className="w-full py-8 sm:py-12 lg:py-16 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-3 sm:mb-4">
          Mengapa Memilih Jagoan Academy?
        </h2>
        <p className="text-center text-gray-500 mb-8 sm:mb-10 lg:mb-12 max-w-2xl mx-auto text-sm sm:text-base">
          Platform kami dirancang untuk memberikan pengalaman belajar terbaik
          dengan berbagai keunggulan yang mendukung kesuksesan Anda.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {features.map((f, i) => (
            <div
              key={i}
              className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 flex flex-col items-center text-center transition hover:shadow-2xl"
            >
              {f.icon}
              <h3 className="font-semibold text-base sm:text-lg mb-2 text-gray-900">
                {f.title}
              </h3>
